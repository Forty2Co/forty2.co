...
See [references/routing.md](../docs/references/routing.md) for complete routing guide.
...
- [API Reference](../docs/references/api_reference.md) — Complete SolidJS primitives, utilities, and component APIs
- [Routing Guide](../docs/references/routing.md) — Solid Router setup, navigation, and patterns
